<?php 
	...
	include_once('php/local/action_admin_user_suggestions.php');		
?>
<!DOCTYPE HTML>
<html lang="en">
<head>
...
<div class="mantis_frame_wrap">
  ...
  <main class="mantis_frame_main">
  	<table border="0" width="100%" class="mantis_posts"> 	
    	<caption>
        <select name="status" onChange="onFilter(this.value)">
          <option value="null" readonly>Filter by: ALL</option>
